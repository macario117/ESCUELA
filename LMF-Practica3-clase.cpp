...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	prisma();
	glTranslatef(2,0,0); // copia el mismo prisma y lo ubicas donde quieras
	prisma();
	glTranslatef(0, 2, 0); // copia el mismo prisma y lo ubicas donde quieras, pero son acomulativas 
	prisma(); */
	...
	glTranslatef(-1, 0, 0);
	prisma();
	//glRotatef(grado,1=afecta x, 0=no afecta y, 0 = no afecta z);
