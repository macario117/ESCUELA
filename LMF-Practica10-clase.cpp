...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	/*text1.LoadBMP("DetailsMB 7.bmp");     Para el mercedes Benz
	text1.BuildGLTexture();
	text1.ReleaseImage();

	text1.LoadBMP("DetailsM.bmp");          Para el mercedes Benz
	text1.BuildGLTexture();
	text1.ReleaseImage();
	*/
	...
	//Carga de Figuras
	kit._3dsLoad("kitt.3ds");	               //kit (con una sola t) es para agregar el mercedes
	//kit.VertexNormals();
